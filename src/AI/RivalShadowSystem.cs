...
namespace TheDarkestNight
{
    public static class RivalShadowSystem
    {
                ...
                switch (schemeType)
                {
                    ...
                    case 2:
                        ...
                        InformationManager.DisplayMessage(new InformationMessage(
                            ...
                            new Color(0.38f, 0.50f, 0.75f)));
                        try { AgingSystem.AgeHero(Hero.MainHero, 1); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                    ...
                    case 3:
                        ...
                        if (goldLost > 50)
                        {
                            try { Hero.MainHero?.ChangeHeroGold(-goldLost); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                            InformationManager.DisplayMessage(new InformationMessage(
        ...
        private static void OnDuelLoss(string shadowName, string reason)
        {
            ...
            try { AgingSystem.AgeHero(Hero.MainHero, 5); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            InformationManager.DisplayMessage(new InformationMessage(
