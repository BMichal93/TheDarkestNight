...
namespace TheDarkestNight
{
    public static partial class EmberConclaveSystem
    {
        ...
        public static void OnHeroKilled(Hero victim, Hero killer)
        {
            ...
            {
                AddPower(-10);
                try { _mainLog?.LogMemberLost(victim.Name?.ToString() ?? "an ember"); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                CheckDefeat();
            }
        ...
        public static void DailyTick()
        {
            ...
            {
                _seeded = true;
                try { TrySeedInitialMembers(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }

            if (_phase >= PhaseStirring && _mainLog == null)
                try { EnsureMainLog(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
        ...
        private static void CheckTierTransitions()
        {
            ...
            if (!_tier1Fired && _power >= PowerTier1)
            {
                ...
                try { EnsureMainLog(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                try { _mainLog?.LogFirstContact(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                try { MageKnowledge._deferredInquiry = ShowFirstContactInquiry; } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
            ...
            if (!_tier2Fired && _power >= PowerTier2)
            {
                ...
                if (_playerIsEnemy)
                {
                    try { _mainLog?.LogEnemyRisingWarning(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                    try
                    {
                ...
                {
                    try { _mainLog?.LogRisingPhase(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                }
            }
            ...
            if (!_tier3Fired && _power >= PowerTier3)
            {
                ...
                try { ChoosePuppetCandidate(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                _corruptionWarningTimer = CorruptionWarningInterval;
                if (_playerIsEnemy)
                {
                    try { _mainLog?.LogEnemyAscendantWarning(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                    try
                    {
                        InformationManager.DisplayMessage(new InformationMessage(
            ...
            if (!_tier4Fired && _power >= PowerTier4)
            {
                _tier4Fired = true;
                _phase = PhaseHubris;
                try { FireCulmination(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
        }
        ...
        private static void ChoosePuppetCandidate()
        {
            try
            {
                ...
                try { _mainLog?.LogPuppetChosen(candidate.Name?.ToString() ?? "a lord"); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
            catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
        }
        ...
        private static void TryOfferMission()
        {
            ...
            if (missionType == MissionEliminate)
            {
                ...
                try { MageKnowledge._deferredInquiry = () => ShowMissionOffer(MissionEliminate, targetName); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
            else if (missionType == MissionVisit)
            {
                ...
                try { MageKnowledge._deferredInquiry = () => ShowMissionOffer(MissionVisit, targetName); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
            else if (missionType == MissionProtect && _puppetCandidateId != null)
            {
                ...
                try { MageKnowledge._deferredInquiry = () => ShowMissionOffer(MissionProtect, targetName); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
            else if (missionType == MissionRuin)
            {
                ...
                try { MageKnowledge._deferredInquiry = () => ShowMissionOffer(MissionRuin, ruinName); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
        }
        ...
        private static void CompleteMissionSuccess()
        {
            ...
            AddPower(15);
            try { GetActiveMissionLog()?.LogSuccess(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            try { GetActiveMissionLog()?.CompleteSuccess(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            ClearActiveMission();
        }
        ...
        private static void FailActiveMission(string reason)
        {
            if (_activeMission == MissionNone) return;
            AddPower(-5);
            try { GetActiveMissionLog()?.LogFailed(reason); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            try { GetActiveMissionLog()?.CompleteFail(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            ClearActiveMission();
        }
        ...
        private static void FireCorruptionWarning()
        {
            try
            {
                ...
                try { _mainLog?.LogCorruptionWarning(text); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
        ...
        private static void ShowAllyEnding()
        {
            ...
            InformationManager.ShowInquiry(new InquiryData(
                ...
                "Leave the hall.",
                "",
                () => { try { ApplyCulmination(allyPath: true); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); } },
                () => { try { ApplyCulmination(allyPath: true); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); } }
            ), true, true);
        }
        ...
        private static void ShowNeutralEnding()
        {
            ...
            InformationManager.ShowInquiry(new InquiryData(
                ...
                "Remember this.",
                "",
                () => { try { ApplyCulmination(allyPath: false); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); } },
                () => { try { ApplyCulmination(allyPath: false); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); } }
            ), true, true);
        }
        ...
        private static void ApplyCulmination(bool allyPath)
        {
            ...
            if (allyPath)
            {
                try { _mainLog?.LogAllyEnding(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                try { _mainLog?.CompleteFail(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
            else
            {
                try { _mainLog?.LogNeutralEnding(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                try { _mainLog?.CompleteFail(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            }
        }
        ...
        private static void CheckDefeat()
        {
            ...
            {
                _phase = PhaseEnded;
                try { _mainLog?.LogDefeat(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                try { _mainLog?.CompleteSuccess(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                InformationManager.DisplayMessage(new InformationMessage(
        ...
        private static void ShowFirstContactInquiry()
        {
            ...
            MBInformationManager.ShowMultiSelectionInquiry(new MultiSelectionInquiryData(
                ...
                chosen =>
                {
                    try { HandleFirstContactChoice(chosen?[0]?.Identifier as string ?? "ignore"); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                },
                null, "", false
            ), false);
        }
        ...
        private static void HandleFirstContactChoice(string choice)
        {
            switch (choice)
            {
                case "ally":
                    _playerIsAlly = true;
                    try { _mainLog?.LogPlayerAllied(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                    InformationManager.DisplayMessage(new InformationMessage(
                ...
                case "enemy":
                    ...
                    try { _mainLog?.LogPlayerOpposed(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                    InformationManager.DisplayMessage(new InformationMessage(
                ...
                default:
                    try { _mainLog?.LogPlayerIgnored(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                    InformationManager.DisplayMessage(new InformationMessage(
        ...
        private static void ShowCounterContactInquiry()
        {
            ...
            InformationManager.ShowInquiry(new InquiryData(
                ...
                "Burn this one too.",
                "",
                () => { try { _mainLog?.LogCounterContact(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); } },
                () => { try { _mainLog?.LogCounterContact(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); } }
            ), true, true);
        }
            ...
            MBInformationManager.ShowMultiSelectionInquiry(new MultiSelectionInquiryData(
                ...
                chosen =>
                {
                    try
                    {
                        ...
                        {
                            try { GetActiveMissionLog()?.LogAccepted(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                        }
                        else
                        {
                            AddPower(-5);
                            try { GetActiveMissionLog()?.LogDeclined(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                            try { GetActiveMissionLog()?.CompleteFail(); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
                            ClearActiveMission();
                        }
                    }
