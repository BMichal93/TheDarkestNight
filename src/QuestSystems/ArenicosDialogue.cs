    ...
    internal static class ArenicosDialogue
    {
        internal static void Register(CampaignGameStarter starter)
        {
            ...
            try { starter.AddDialogLine("ar_true_start",
                ...
                IsTrueEmperorGreeting, null, P); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }

            try { starter.AddDialogLine("ar_true_pretalk",
                "lord_pretalk", "ar_reply",
                "The Empire does not wait long. Neither do I. What is it?",
                IsTrueEmperor, null, P); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            ...
            try { starter.AddDialogLine("ar_false_start",
                ...
                IsFalseEmperorGreeting, null, P); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
            ...
            try { starter.AddDialogLine("ar_false_pretalk",
                ...
                IsFalseEmperor, null, P); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }

            // ── Shared player responses ───────────────────────────────────────
            try { starter.AddPlayerLine("ar_reply_serve",
                "ar_reply", "close_window",
                "Long live the Emperor.",
                null, null, P); } catch (System.Exception logEx) { TheDarkestNight.ModLog.Error(logEx); }
