...
namespace TheDarkestNight
{
    ...
    {
        // ── Event 19: Mage Fatwa ─────────────────────────────────────────────
        // Religious terror sweeps a random non-cult stronghold. Fanatics hunt
        // mage lords — 0–3 are killed by the mob before the violence is spent.
        // cult lords are immune (the mob does not touch what it truly fears).
        //
        // Safety constraints:
        ...
        //
        // Safety: looter parties use the same hideout-safe pattern as demons.
        ...
        // Cult assassins — woven through every Imperial court like cold thread —
        ...
        //   Phase 4 — Spawn AshenGambitSpawnCount demons warbands, each with
        ...
        private static void TryFireAshenGambit()
        {
            ...
            try
            {
                ...
                // Surge cult lord party morale — push them into aggressive campaigning
