...
namespace TheDarkestNight
{
    ...
    public static class SpellbookCatalog
    {
        ...
        private static readonly List<SpellDef> _defs = new List<SpellDef>
        {
            ...
            new SpellDef { Id = SpellId.EmberWard, Name = "Warding Rune", Formula = "LRUDLRUD",
                Description = "A protective rune scrived close about you — armour of a kind, and a little mending besides." },
