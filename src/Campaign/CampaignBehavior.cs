...
namespace TheDarkestNight
{
    public partial class MagicCampaignBehavior : CampaignBehaviorBase
    {
        ...
        private static readonly string[] _premonitions =
        {
            ...
            "You wake with the taste of ink and iron on your tongue. The marks you know are restless.",
            "Your shadow moves a half-step behind you. Something at the edge of your workings is watching what you cannot.",
            ...
            "The work does not sleep when you do. You feel it turning over in your memory, searching.",
            "Somewhere far off, someone is drawing. You know it the way a scribe knows another hand.",
            ...
            "The dying man reaches for your hand. You let him. You trace a small mark on his palm — not much, but something.",
            ...
            "The lines show you a face tonight. Someone you haven't met yet. Or someone you have, changed by time.",
            "You press your palm against cold stone and feel it remember warmth. Every stone remembers something.",
            "A soldier dies in the battle beside you. For a moment, the line that held him is visible — a last unravelling. Then nothing.",
            "The stars are wrong tonight. Not the positions — the light. Too old. Too far. The lines know things you don't, and they are not telling you.",
